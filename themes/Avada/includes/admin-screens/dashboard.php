			...
			<div class="avada-db-card-grid">
				<div class="avada-db-card-notice avada-db-welcome-resources-license">
					...
					<p class="avada-db-card-notice-content">
						...
						?>
						<a href="<?php echo esc_url( 'https://1.envato.market/nYa3R' ); ?>" class="button button-primary<?php echo esc_attr( $sale_classes ); ?>" target="_blank" rel="noopener noreferrer"><span class="avada-db-buy-now-button-text"><?php echo esc_html( $buy_button_text ); ?></span></a>
					</p>
				</div>
