 ...
 */
if ( is_admin() && ( isset( $_GET['page'] ) && 'avada-status' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) || ( fusion_doing_ajax() && isset( $_GET['action'] ) && 'fusion_check_api_status' === $_GET['action'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification
