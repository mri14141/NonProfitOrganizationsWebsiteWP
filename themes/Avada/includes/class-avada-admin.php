...
class Avada_Admin {
	...
	public function admin_menu() {
		...
		if ( current_user_can( 'switch_themes' ) ) {
			...
			$dashboard         = $avada_menu_page_creation_method( 'Avada', 'Avada', 'switch_themes', 'avada', [ $this, 'dashboard_screen' ], 'dashicons-avada', '2.111111' );
	...
	public static function get_admin_screens_header( $screen = 'welcome' ) {
		...
		if ( in_array( $screen, [ 'builder-options', 'layout-sections', 'layouts', 'icons', 'library' ], true ) ) {
